...
<form action="register_code_staff.php" method="post">
    ...
    <div class="input-group">
        ...
        <input type="text" class="bookbox" name="n_funcionario" placeholder="Nº do funcionário" style=" FontAwesome"
               pattern=".{1,5}" title="Por favor, coloque o seu nº de funcionário" required>
    </div>
    <div class="input-group">
    ...
    <div class="input-group">
        <button type="button" name="cancelar" class="btncancelar" onclick="window.location='index_login_staff.php'" />Cancelar</button>&nbsp;&nbsp;&nbsp;
