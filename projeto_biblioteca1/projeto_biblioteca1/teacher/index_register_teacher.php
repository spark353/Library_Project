...
<form action="register_code_teacher.php" method="post">
    ...
    <div class="input-group">
        ...
        <input type="text" class="bookbox" name="n_professor" placeholder="nº do professor" style=" FontAwesome"
               pattern=".{1,5}" title="Por favor, coloque o seu nº de professor" required>
    </div>
    <div class="input-group">
    ...
    <div class="input-group">
        <button type="button" name="cancelar" class="btncancelar" onclick="window.location='index_login_teacher.php'" />Cancelar</button>&nbsp;&nbsp;&nbsp;
